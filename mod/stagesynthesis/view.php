...
/**
 * Vue de synthèse : reprend l'écran de validation enseignant de mod_stage (teacher.php) --
 * conventions en attente, liste filtrable/triable des saisies en attente d'évaluation -- mais
 * combiné sur toutes les activités "Gestion des stages" liées où l'utilisateur connecté est
 * enseignant référent, plutôt que sur une seule promotion.
 *
...
$baseurl = new moodle_url('/mod/stagesynthesis/view.php', ['id' => $cm->id]);
